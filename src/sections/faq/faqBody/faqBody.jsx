...
const general = [
  {
    question: "What is Meinor Foundation?",
    answer:
      "Meinor Foundation, a non-profit organization, is devoted to transforming lives globally through healthcare, education, and humanitarian aid. By focusing on critical health issues, providing educational opportunities, and offering support in times of crisis, the foundation strives to create a lasting impact and contribute to positive change across communities and borders.",
  },
  {
    question: "What is the story of Meinor Foundation?",
    answer:
      "The story of Meinor Foundation is one rooted in compassion, dedication, and a fervent desire to make a positive impact on a global scale. Founded with a vision to transform lives through healthcare, education, and humanitarian aid, the foundation's journey began with the recognition of the profound challenges faced by individuals and communities worldwide. Driven by a sense of responsibility and a commitment to address pressing issues, Meinor Foundation emerged as a non-profit organization dedicated to bringing about meaningful change. The founders, inspired by the belief that everyone deserves access to healthcare, quality education, and support in times of crisis, set out to create an organization that would serve as a beacon of hope and empowerment. Throughout its evolution, Meinor Foundation has forged partnerships, implemented impactful programs, and responded to crises with resilience and determination. The foundation's initiatives range from supporting healthcare infrastructure and providing educational opportunities to delivering humanitarian aid in times of need. The story of Meinor Foundation is one of growth, collaboration, and a relentless pursuit of a better world. It is shaped by the collective efforts of individuals who share a common goal: to contribute to the well-being of humanity. As the foundation continues to make strides in its mission, the narrative unfolds with each life touched, each community uplifted, and each challenge met with unwavering resolve. It is a story that invites others to join in the journey, as together, we strive to create a more compassionate, equitable, and sustainable future for all.",
  },
  {
    question: "How can I contact Meinor Foundation?",
    answer:
      "Feel free to connect with us either by visiting our contact page on the website or reaching out to us directly at contact@meinor.org. We look forward to hearing from you and addressing any inquiries or feedback you may have.",
  },
];

const donation = [
  {
    question: "How can I make a donation to Meinor Foundation?",
    answer:
      "We focus on impactful collaborations with businesses and higher-value donations. While we don't currently have an online donation process, we prioritize partnerships to maximize our collective impact. Explore how your company's values align with ours. Let's work together to make a real difference through strategic alliances and corporate social responsibility. Have questions or want to discuss partnership opportunities? Reach out to us at contact@meinor.org.",
  },
  {
    question: "Is my donation tax-deductible?",
    answer:
      "Donations made to Meinor Foundation are tax-deductible in several countries, including the United States, Germany, Canada, the Netherlands, France, South Korea, and certain regions of Australia. Your support makes a meaningful impact, and we appreciate your contribution to our mission. You can reach out to us for partnership inquiries at partner@meinor.org.",
  },
];

const impact = [
  {
    question: "How does Meinor Foundation measure its impact?",
    answer:
